...
salvo excepciones (https://huggingface.co/ibm-granite/granite-4.0-h-micro-GGUF y https://huggingface.co/mistralai/Ministral-3-3B-Instruct-2512-GGUF) se ha empleado el safetensors original
 ...
 '''
 así para ls seis modelos que posteriormente se han usado para aplicarselos a las cuantizaciones merdiante el siguente script  apply modelfiles junto con aply modelfiles, disponible en el repositorio de hugging face [repositorio huggingface](https://huggingface.co/buckets/jescarcar5/MODELOS-TFG)
  se añaden y configuran los modelfiles al ollama junto con los modelos, se procede a confugurar el testeo y se establece el swap a 2 gb, autologin activo,
  doy la orden de reinicio y el test E0 sin ventilador comienza 

 # 2026-05-19
  Fallo en la ejecución, E0 sin ventilador aguanto 18 prompt ollama ministral 2 horas y 12 minutos 
  cambiado la obtencion de la frecuencia por vgencmd y eumentao el timeout a 5 horas en monitor system
