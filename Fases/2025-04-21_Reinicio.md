...
1. Convertir las carpetas a paquetes(error de novato) y configurar correctamente el gitignore
2. Completar llama.cpp.
3. Confiigurar el keepalive de ollama para que se desactive con el últmo prompt. 
